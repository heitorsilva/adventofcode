...
for cube in CUBES:
    ...
    if area1 < area2 and area1 < area3:
        ...
        extra = area3
    elif (area1 == area2 and area1 == area3) or (area1 == area2 and area1 < area3):
        extra = area1
...
for cube in CUBES:
    if cube[0] < cube[1] and cube[1] < cube[2] or \
       cube[0] < cube[1] and cube[1] == cube[2] or \
       cube[1] < cube[0] and cube[0] < cube[2] or \
       cube[0] == cube[1] and cube[1] < cube[2] or \
       cube[0] == cube[2] and cube[0] > cube[1]:
        ribbon = cube[0] + cube[0] + cube[1] + cube[1]
    elif cube[0] < cube[1] and cube[2] < cube[1] or \
         cube[0] == cube[1] and cube[0] > cube[2]:
        ribbon = cube[0] + cube[0] + cube[2] + cube[2]
    elif cube[1] < cube[2] and cube[2] < cube[0] or \
         cube[2] < cube[1] and cube[1] < cube[0]:
        ribbon = cube[1] + cube[1] + cube[2] + cube[2]
    elif cube[2] < cube[0] and cube[0] < cube[1]:
        ribbon = cube[2] + cube[2] + cube[0] + cube[0]
    elif cube[0] == cube[1] and cube[1] == cube[2]:
        ribbon = cube[0] + cube[0] + cube[0] + cube[0]
    elif cube[0] > cube[1] and cube[1] == cube[2]:
        ribbon = cube[1] + cube[1] + cube[1] + cube[1]

    ribbon += cube[0] * cube[1] * cube[2]
